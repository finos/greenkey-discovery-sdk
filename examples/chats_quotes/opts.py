...
def general_opts():
    ...
    parser.add_argument("--expected-intent", required=False, type=str, help="Intent corresponding to transcript")
...
def single_test(parser):
    parser.add_argument("--test-no", required=True,  help="Unique number for test of this transcript")
    parser.add_argument(
        "--transcript",
        required=True,
        type=str,
