...
quote_segments = (
        first_500 + second_500_to_1000
        + third_1000_to_2000 + fourth_2000_to_4000
        + last_4000_to_6505
)
...
len(not_quote_segments), len(not_quote_segments_updated)    # one of the not_quote_segments did not have any text so it is effectively removed during update
...
write_intent_test_file(
  directory,
  segments=quote_segments_updated,
  intent='quote',
  test_size=10,
  formatted=True)
...
write_intent_test_file(
  directory,
  segments=not_quote_segments_updated,
  intent='not_quote',
  test_size=10,
  formatted=True)
